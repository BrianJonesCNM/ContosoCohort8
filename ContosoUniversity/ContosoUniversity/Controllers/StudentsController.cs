...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString, string currentFilter,
            int? page)
        {
            ViewData["NameSortParam"] = sortOrder;
            ...
            {
                students = students.Where(y => y.LastName.Contains(searchString)
                || y.FirstMidName.Contains(searchString));
            }
        ...
        public async Task<IActionResult>
            Create([Bind("LastName,FirstMidName,EnrollmentDate")] Student student)
        {
            try
            {
            ...
            {
                ModelState.AddModelError("","Unable to save changes, contact Meagan for support");
            }
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            if(await TryUpdateModelAsync<Student>(studentToUpdate, "", y=> y.FirstMidName, y=> y.LastName,
                y => y.EnrollmentDate))
            {
                try { 
                await _context.SaveChangesAsync();
                ...
                {
                    ModelState.AddModelError("","Error occured please contact Meagan's back up Tate");
                }
            }
